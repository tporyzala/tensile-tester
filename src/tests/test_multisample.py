...
class MultiSampleTests(unittest.TestCase):
    ...
    def test_finalize_active_sample_summary_and_exports(self):
        ...
        self.assertEqual(worksheet_number(summary_cells, "B6"), 2.0)
        self.assertEqual(worksheet_number(summary_cells, "C6"), 35.0)
        self.assertEqual(worksheet_number(summary_cells, "D6"), -5.0)
        self.assertEqual(worksheet_number(summary_cells, "E6"), 75.0)
        self.assertAlmostEqual(worksheet_number(summary_cells, "F6"), 56.5685, places=4)
        self.assertEqual(worksheet_number(summary_cells, "B7"), 2.0)
        self.assertEqual(worksheet_number(summary_cells, "C7"), 3.8)
        self.assertEqual(worksheet_number(summary_cells, "D7"), 0.6)
        self.assertEqual(worksheet_number(summary_cells, "E7"), 7.0)
        self.assertAlmostEqual(worksheet_number(summary_cells, "F7"), 4.5255, places=4)
    ...
    def test_stop_retains_partial_sample_and_returns_to_idle(self):
        ...
        self.assertTrue(monitor._sample_records[0].included)
